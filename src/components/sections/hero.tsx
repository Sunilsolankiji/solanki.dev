                ...
                <Row className="g-4 g-lg-5 align-items-center">
                    <Col lg={ 6 } className={ `order-2 order-lg-1 hero-reveal ${ mounted ? 'hero-reveal-in' : '' }` }>
                        <div className="mb-4">
                            ...
                            <div className="hero-role fw-semibold mb-2">
                                <Typewriter words={ roles }/>
                            </div>
                            <div className="eyebrow availability"><span className="status-dot"/> Available for select
                                opportunities
                            </div>
                            <p className="hero-subtitle text-secondary">
                                Frontend engineer crafting thoughtful, high-performance interfaces and developer tools
                                with Angular, React, TypeScript, and JavaScript.
                            </p>
                    ...
                    <Col lg={ 6 }
                         className={ `order-1 order-lg-2 text-center hero-reveal hero-reveal-delay ${ mounted ? 'hero-reveal-in' : '' }` }>
                        <div className="hero-visual">
                            <div className="code-card">
                                <div className="code-card-bar"><span/><span/><span/><small>sunil.ts</small></div>
                                <div className="code-card-content">
                                    <span className="code-muted">const</span> <span
                                    className="code-blue">developer</span> = { '{' }<br/>
                                    <span className="code-indent">name: <span
                                        className="code-green">'Sunil Solanki'</span>,</span><br/>
                                    <span className="code-indent">focus: <span className="code-green">'great UX'</span>,</span><br/>
                                    <span className="code-indent">ships: <span
                                        className="code-purple">true</span></span><br/>
                                    { '}' };
                                </div>
                            </div>
